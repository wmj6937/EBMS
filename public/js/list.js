		...
		success : function(res){
			...
			if(len){
				...
				$.each(query,function(data){
					...
					var price = query[data].goods_price + ".00";
					$(".record").append('<ul class="list_header"><li id="goods_num"><input type="checkbox" name="">' + num + '</li><li><input type="text" name="" value="'+ name + '" id="goods_name"></li><li><input type="text" name="" value="' + code + '" id="goods_code"></li><li><input type="text" name="" value="' + price + '" id="goods_price"></li><li class="off"><img src="/img/yes.gif"></li><li  class="off"><img src="/img/no.gif"></li><li  class="off"><img src="/img/no.gif"></li><li  class="off"><img src="/img/no.gif"></li><li><input type="text" name="" value="100"></li><li><input type="text" name="" value="1"></li><li><input type="text" name="" value="0"></li><li class="change"><img src="/img/icon_view.gif"><img src="/img/icon_edit.gif"><img src="/img/icon_copy.gif"><img src="/img/icon_trash.gif"></li></ul>');
				})
				var width_input = $(".record input[type='text']");
				dem(width_input);
				width_input.bind({
					keyup : function(){
...
//图片编辑
$(".record").on("click",".off img",function(){
...
//删除功能
$(".record").on("click",".change img",function(){
...
//改
$(".record").on("change","input[type='text']",function(){
